...
struct worker_thread
{
	...
	int produce_sp_tree_and_cycles_warp(int src_index,csr_multi_graph *graph)
	{
		...
		trees->get_node_arrays_warp(&csr_rows,&csr_cols,&csr_edge_offset,&csr_parent,
									  &csr_distance,&csr_nodes_index,src_index);

		helper->fill_tree_edges(csr_rows,csr_cols,csr_nodes_index,csr_edge_offset,csr_parent,csr_distance,src);
