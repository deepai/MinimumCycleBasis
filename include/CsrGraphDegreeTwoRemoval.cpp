 ...
 */
std::vector<unsigned> *csr_graph::mark_degree_two_chains(std::vector<std::vector<unsigned> > **chain,int &src)
{
	struct DFS_HELPER
	{
		int Nodes;
		...
		DFS_HELPER(std::vector<unsigned> *rows,
			   std::vector<unsigned> *columns,
			   std::vector<unsigned> *rowOffsets,
			   std::vector<unsigned> *degree,
			   std::vector<std::vector<unsigned> > **chain,
			   int _nodes)
		{
